...
* [foreman](https://github.com/theforeman/foreman) ⭐ 2,904 | 🐛 109 | 🌐 Ruby | 📅 2026-08-14 - "From provisioning and configuration to orchestration and monitoring, Foreman integrates with your existing infrastructure to make operations easier"
* [cobbler](https://github.com/cobbler/cobbler) ⭐ 2,768 | 🐛 316 | 🌐 Python | 📅 2026-08-14 - "Cobbler is a Linux installation server that allows for rapid setup of network installation environments"
* [Typhoon](https://github.com/poseidon/typhoon/) ⭐ 2,050 | 🐛 7 | 🌐 HCL | 📅 2026-08-07 - "A minimal and free Kubernetes distribution with Terraform backed by Fedora CoreOS or Flatcar Linux"
* [pixiecore](https://github.com/danderson/netboot/tree/master/pixiecore) ⭐ 1,606 | 🐛 36 | 🌐 Go | 📅 2026-02-01 "Pixiecore is an tool to manage network booting of machines" by Dave Anderson
* [iDRAC 6 dockerized](https://github.com/DomiStyle/docker-idrac6) ⭐ 930 | 🐛 40 | 🌐 C | 📅 2026-02-28 "Allows access to the iDRAC 6 console without installing Java or messing with Java Web Start." by DomiStyle
* [Warewulf](https://github.com/warewulf/warewulf) ⭐ 660 | 🐛 261 | 🌐 Go | 📅 2026-08-12 - "Warewulf is a stateless and diskless container operating system provisioning system for large clusters of bare metal and/or virtual systems."
* [ironic](https://github.com/openstack/ironic) ⭐ 559 | 🐛 0 | 🌐 Python | 📅 2026-08-14 "A service for managing and provisioning Bare Metal servers" - from OpenStack Foundation
* [metalk8s](https://github.com/scality/metalk8s) ⭐ 391 | 🐛 497 | 🌐 Scheme | 📅 2026-08-14 - "MetalK8s was launched to make it easier to run Kubernetes (K8s) on bare-metal servers that need persistent storage" by Scality
* [mr-provisioner](https://github.com/mr-provisioner/mr-provisioner) ⭐ 46 | 🐛 88 | 🌐 JavaScript | 📅 2023-01-12 - "Bare metal provisioning tool"
* [confluent](https://github.com/lenovo/confluent) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - "Service for onboarding and management of baremetal server BMCs and PXE"
...
* [kube-vip](https://github.com/plunder-app/kube-vip) ⭐ 2,932 | 🐛 51 | 🌐 Go | 📅 2026-08-12 - "Kubernetes Control Plane Virtual IP and Load-Balancer"
* [PorterLB](https://github.com/kubesphere/porterlb) ⭐ 1,775 | 🐛 78 | 🌐 Go | 📅 2025-05-26 - "PorterLB is an open-source load balancer implementation designed for bare-metal Kubernetes clusters."
* [inlets-operator](https://github.com/inlets/inlets-operator) ⭐ 1,436 | 🐛 9 | 🌐 Go | 📅 2026-04-08 - "Public IPs for your private Kubernetes Services using inlets"
* [inlets](https://github.com/inlets/inlets-pro) ⭐ 575 | 🐛 3 | 🌐 Mustache | 📅 2026-07-14 - "A Cloud Native Tunnel for L4 TCP and L7 HTTPS" (sponsored)
...
* [Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,108 | 🐛 219 | 🌐 Rust | 📅 2026-08-15
* [Ganeti](https://github.com/ganeti/ganeti) ⭐ 578 | 🐛 333 | 🌐 Python | 📅 2026-07-27 - "Open source hyperconverged VM platform that scales from several to thousands of bare metal servers. Originally written for internal use at Google."
...
* [SeaweedFS](https://github.com/seaweedfs/seaweedfs) ⭐ 34,069 | 🐛 766 | 🌐 Go | 📅 2026-08-15 - Apache 2.0 - "SeaweedFS is a fast distributed storage system for blobs, objects, files, and data lake, for billions of files"
