...
* [LinuxKit](https://github.com/linuxkit/linuxkit) ⭐ 8,650 | 🐛 376 | 🌐 Go | 📅 2026-09-08 - "A toolkit for building secure, portable and lean operating systems for containers" - PXE support, focus on immutable infrastructure.
...
* [Warewulf](https://github.com/warewulf/warewulf) ⭐ 662 | 🐛 262 | 🌐 Go | 📅 2026-09-11 - "Warewulf is a stateless and diskless container operating system provisioning system for large clusters of bare metal and/or virtual systems."
...
* [kube-vip](https://github.com/plunder-app/kube-vip) ⭐ 2,953 | 🐛 80 | 🌐 Go | 📅 2026-09-10 - "Kubernetes Control Plane Virtual IP and Load-Balancer"
...
* [SeaweedFS](https://github.com/seaweedfs/seaweedfs) ⭐ 34,611 | 🐛 760 | 🌐 Go | 📅 2026-09-13 - Apache 2.0 - "SeaweedFS is a fast distributed storage system for blobs, objects, files, and data lake, for billions of files"
