...
* [LinuxKit](https://github.com/linuxkit/linuxkit) ⭐ 8,652 | 🐛 375 | 🌐 Go | 📅 2026-09-22 - "A toolkit for building secure, portable and lean operating systems for containers" - PXE support, focus on immutable infrastructure.
* [foreman](https://github.com/theforeman/foreman) ⭐ 2,927 | 🐛 121 | 🌐 Ruby | 📅 2026-09-22 - "From provisioning and configuration to orchestration and monitoring, Foreman integrates with your existing infrastructure to make operations easier"
* [cobbler](https://github.com/cobbler/cobbler) ⭐ 2,773 | 🐛 308 | 🌐 Python | 📅 2026-09-23 - "Cobbler is a Linux installation server that allows for rapid setup of network installation environments"
* [Typhoon](https://github.com/poseidon/typhoon/) ⭐ 2,052 | 🐛 8 | 🌐 HCL | 📅 2026-09-23 - "A minimal and free Kubernetes distribution with Terraform backed by Fedora CoreOS or Flatcar Linux"
...
* [iDRAC 6 dockerized](https://github.com/DomiStyle/docker-idrac6) ⭐ 936 | 🐛 41 | 🌐 C | 📅 2026-02-28 "Allows access to the iDRAC 6 console without installing Java or messing with Java Web Start." by DomiStyle
...
* [confluent](https://github.com/lenovo/confluent) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - "Service for onboarding and management of baremetal server BMCs and PXE"
...
* [kube-vip](https://github.com/plunder-app/kube-vip) ⭐ 2,966 | 🐛 79 | 🌐 Go | 📅 2026-09-21 - "Kubernetes Control Plane Virtual IP and Load-Balancer"
...
* [Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,251 | 🐛 226 | 🌐 Rust | 📅 2026-09-23
* [Ganeti](https://github.com/ganeti/ganeti) ⭐ 586 | 🐛 333 | 🌐 Python | 📅 2026-09-22 - "Open source hyperconverged VM platform that scales from several to thousands of bare metal servers. Originally written for internal use at Google."
...
* [SeaweedFS](https://github.com/seaweedfs/seaweedfs) ⭐ 34,915 | 🐛 774 | 🌐 Go | 📅 2026-09-23 - Apache 2.0 - "SeaweedFS is a fast distributed storage system for blobs, objects, files, and data lake, for billions of files"
