...
* [LinuxKit](https://github.com/linuxkit/linuxkit) ⭐ 8,649 | 🐛 376 | 🌐 Go | 📅 2026-09-08 - "A toolkit for building secure, portable and lean operating systems for containers" - PXE support, focus on immutable infrastructure.
* [foreman](https://github.com/theforeman/foreman) ⭐ 2,915 | 🐛 106 | 🌐 Ruby | 📅 2026-09-11 - "From provisioning and configuration to orchestration and monitoring, Foreman integrates with your existing infrastructure to make operations easier"
* [cobbler](https://github.com/cobbler/cobbler) ⭐ 2,772 | 🐛 308 | 🌐 Python | 📅 2026-09-02 - "Cobbler is a Linux installation server that allows for rapid setup of network installation environments"
* [Typhoon](https://github.com/poseidon/typhoon/) ⭐ 2,052 | 🐛 6 | 🌐 HCL | 📅 2026-08-31 - "A minimal and free Kubernetes distribution with Terraform backed by Fedora CoreOS or Flatcar Linux"
* [pixiecore](https://github.com/danderson/netboot/tree/master/pixiecore) ⭐ 1,611 | 🐛 36 | 🌐 Go | 📅 2026-02-01 "Pixiecore is an tool to manage network booting of machines" by Dave Anderson
* [iDRAC 6 dockerized](https://github.com/DomiStyle/docker-idrac6) ⭐ 935 | 🐛 40 | 🌐 C | 📅 2026-02-28 "Allows access to the iDRAC 6 console without installing Java or messing with Java Web Start." by DomiStyle
* [Warewulf](https://github.com/warewulf/warewulf) ⭐ 662 | 🐛 261 | 🌐 Go | 📅 2026-09-11 - "Warewulf is a stateless and diskless container operating system provisioning system for large clusters of bare metal and/or virtual systems."
* [ironic](https://github.com/openstack/ironic) ⭐ 564 | 🐛 0 | 🌐 Python | 📅 2026-09-09 "A service for managing and provisioning Bare Metal servers" - from OpenStack Foundation
* [metalk8s](https://github.com/scality/metalk8s) ⭐ 394 | 🐛 486 | 🌐 Scheme | 📅 2026-09-11 - "MetalK8s was launched to make it easier to run Kubernetes (K8s) on bare-metal servers that need persistent storage" by Scality
* [mr-provisioner](https://github.com/mr-provisioner/mr-provisioner) ⭐ 46 | 🐛 88 | 🌐 JavaScript | 📅 2023-01-12 - "Bare metal provisioning tool"
* [confluent](https://github.com/lenovo/confluent) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - "Service for onboarding and management of baremetal server BMCs and PXE"
...
* [Razor](https://github.com/puppetlabs/razor-server) ⚠️ Archived (archived) - "Razor is next generation provisioning software that handles bare metal hardware and virtual server provisioning"
* [plundr](https://github.com/plunder-app/plunder) ⭐ 183 | 🐛 15 | 🌐 Go | 📅 2020-05-20 (inactive on GitHub - 4yrs) - "Plunder is a single-binary server that is all designed in order to make the provisioning of servers, platforms and applications easier." - with ClusterAPI support
...
* [kube-vip](https://github.com/plunder-app/kube-vip) ⭐ 2,952 | 🐛 78 | 🌐 Go | 📅 2026-09-10 - "Kubernetes Control Plane Virtual IP and Load-Balancer"
* [PorterLB](https://github.com/kubesphere/porterlb) ⭐ 1,773 | 🐛 77 | 🌐 Go | 📅 2025-05-26 - "PorterLB is an open-source load balancer implementation designed for bare-metal Kubernetes clusters."
* [inlets-operator](https://github.com/inlets/inlets-operator) ⭐ 1,435 | 🐛 8 | 🌐 Go | 📅 2026-08-18 - "Public IPs for your private Kubernetes Services using inlets"
* [inlets](https://github.com/inlets/inlets-pro) ⭐ 574 | 🐛 1 | 🌐 Mustache | 📅 2026-09-08 - "A Cloud Native Tunnel for L4 TCP and L7 HTTPS" (sponsored)
...
* [Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,213 | 🐛 222 | 🌐 Rust | 📅 2026-09-11
* [Ganeti](https://github.com/ganeti/ganeti) ⭐ 584 | 🐛 338 | 🌐 Python | 📅 2026-09-07 - "Open source hyperconverged VM platform that scales from several to thousands of bare metal servers. Originally written for internal use at Google."
...
* [SeaweedFS](https://github.com/seaweedfs/seaweedfs) ⭐ 34,582 | 🐛 773 | 🌐 Go | 📅 2026-09-11 - Apache 2.0 - "SeaweedFS is a fast distributed storage system for blobs, objects, files, and data lake, for billions of files"
